    ...
    def mp3(self):
        ...
        for f in os.listdir(directory):
            if (f.endswith(self.ext)):
                os.system("ffmpeg -i {} -ar 44100 -ac 2 -b:a 192k {}/{}.wav".format(
...
if __name__ == '__main__':
    path = input("Enter the full path of your mp3 file directory: ")
    conv = mp3_converter(path, ".mp3", "wav")
    conv.lower_underscore()
    conv.mp3()
    conv.make_dir()
    print("WAV's converted to MP3's and stored in new directory!")